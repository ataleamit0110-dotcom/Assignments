...
# Logistic AUC: 0.9016508537937061
# KNN AUC: 0.8211117645377305
# Random Forest AUC: 0.9184247326304298
...
plt.plot(fpr_log, tpr_log, label="Logistic (AUC = 0.90)")
plt.plot(fpr_knn, tpr_knn, label="KNN (AUC = 0.82)")
plt.plot(fpr_rf, tpr_rf, label="Random Forest (AUC = 0.91)")
